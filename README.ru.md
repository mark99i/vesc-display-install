...
- Два режима интерфейса: экспертный (как на скриншотах) и упрощенный
  ...
  - В упрощенном интерфейсе отображается текущая скорость, а также сведений о сессии и данных с последнего старта при остановке. Для настройки доступны 3 параметра
